...
<style>
  ...
  .btn-signin { background:#0069ff; color:#fff; font-weight:bold; }
...
<div class="container" id="loginContainer">
  ...
  <div class="forgot-pass" onclick="window.location.href='forget-password'" style="color:#0069ff; font-size:13px; cursor:pointer;">Forgot password?</div>
  <br>
...
function loginUser() {
  ...
  fetch("https://pulsepoint.com.ng/api/login", {
    method: "POST",
